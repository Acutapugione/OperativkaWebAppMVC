...
namespace Operativka.Controllers
{
    ...
    public class DistrictsController : Controller
    {
        ...
        public DistrictsController(OperativkaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Districts != null ? 
                          ...
                          Problem("Entity set 'OperativkaContext.Districts'  is null.");
        }
        ...
        [Authorize(Roles = "Moderator")]
        public async Task<IActionResult> Create([Bind("Id,Name,OrgId")] District district)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Moderator")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,OrgId")] District district)
        {
            if (id != district.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OperativkaContext.Districts'  is null.");
            }
            var district = await _context.Districts.FindAsync(id);
            if (district != null)
            {
