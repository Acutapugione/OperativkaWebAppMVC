...
namespace Operativka.Migrations
{
    ...
    [Migration("20220610075452_Заявка+Потребители")]
    partial class ЗаявкаПотребители
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Operativka.Models.ApplicationDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsFromOuterApp")
                        .HasColumnType("bit");

                    b.Property<string>("OuterAppNum")
            ...
            modelBuilder.Entity("Operativka.Models.ApplicationObjective", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ApplicationObjectives", (string)null);
                });

            modelBuilder.Entity("Operativka.Models.Consumer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("PersonalAccountCode")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Operativka.Models.ApplicationDocument", b =>
                {
                    b.HasOne("Operativka.Models.Consumer", "Consumer")
                        .WithMany()
            ...
            modelBuilder.Entity("Operativka.Models.ApplicationObjective", b =>
                {
                    b.HasOne("Operativka.Models.ApplicationDocument", "ApplicationDocument")
                        .WithMany("ApplicationObjectives")
            ...
            modelBuilder.Entity("Operativka.Models.ApplicationDocument", b =>
                {
                    b.Navigation("ApplicationObjectives");
                });
